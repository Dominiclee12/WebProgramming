...
<head>
  ...
  <title>Mobility Care Ordering System : Orders</title>
  <!-- Bootstrap -->
  <link href="css/bootstrap.min.css" rel="stylesheet">

  <!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
  <!-- WARNING: Respond.j
    s doesn't work if you view the page via file:// -->
    <!--[if lt IE 9]>
  ...
  <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
    ...
    <table class="table table-striped table-bordered">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT * FROM tbl_orders_a170586, tbl_staffs_a170586_pt2, tbl_customers_a170586_pt2 WHERE ";
        $sql = $sql."tbl_orders_a170586.fld_staff_num = tbl_staffs_a170586_pt2.fld_staff_num and ";
        $sql = $sql."tbl_orders_a170586.fld_customer_num = tbl_customers_a170586_pt2.fld_customer_num";
    ...
    <nav>
      <ul class="pagination">
        ...
        try {
          $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
          $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_orders_a170586");
          $stmt->execute();
          $result = $stmt->fetchAll();
